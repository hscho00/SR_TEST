...
{
    if (FAILED(m_pGraphic_Device->ReadyGraphicDevice(hWnd, iWinCX, iWinCY, eDisplaymode)))
        return E_FAIL;
...
LPDIRECT3DDEVICE9 Management::GetDevice()
{
    ...
    return m_pGraphic_Device->Get_Device_();
}
