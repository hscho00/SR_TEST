...
HRESULT CVIBuffer_TriColor::ReadyComponentPrototype()
{
	...
	pVertex[0].iColor = D3DCOLOR_ARGB(255, 255, 255, 0);

	pVertex[1].vPosition = D3DXVECTOR3(1.f, -1.f, 0.f);
	pVertex[1].iColor = D3DCOLOR_ARGB(255, 255, 255, 0);

	pVertex[2].vPosition = D3DXVECTOR3(-1.f, -1.f, 0.f);
	pVertex[2].iColor = D3DCOLOR_ARGB(255, 255, 255, 0);
...
{
	if (FAILED(CVIBuffer::ReadyComponent()))
		return E_FAIL;
