...
HRESULT CComponentManager::AddComponentprototype(_int iSceneIndex, const wstring & ComponentTag, CComponent * pPrototype)
{
...
CComponent * CComponentManager::CloneComponentPrototype(_int iSceneIndex, const wstring & ComponentTag, void * pArg)
{
	if (0 > iSceneIndex || m_iSceneCount <= iSceneIndex)
	{
		PRINT_LOG(L"Error", L"Out of range Component PrototypeContainer");
